...
fn toml_item(value: &Value) -> ConfigResult<toml_edit::Item> {
    match value {
        Value::Null => Err(ConfigError::UnsupportedOperation {
            format: "TOML".to_string(),
            operation: "set".to_string(),
        ...
        Value::Array(_) | Value::Object(_) => Err(ConfigError::UnsupportedOperation {
            format: "TOML".to_string(),
            operation: "set".to_string(),
