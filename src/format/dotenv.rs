...
fn parse_semantic(content: &str) -> ConfigResult<Value> {
...
pub fn save(_value: &Value) -> ConfigResult<String> {
...
pub fn set_scalar_preserving(content: &str, key: &str, value: &Value) -> ConfigResult<String> {
...
pub fn unset_preserving(content: &str, key: &str) -> ConfigResult<String> {
    edit_line(content, key, None)
}

fn edit_line(content: &str, key: &str, replacement: Option<&str>) -> ConfigResult<String> {
    if !valid_key(key) {
...
fn unsupported(operation: &str, detail: &str) -> ConfigError {
...
fn parse_value(input: &str, line_number: usize) -> ConfigResult<String> {
...
fn parse_quoted(input: &str, quote: char, line_number: usize) -> ConfigResult<String> {
...
fn parse_unquoted(input: &str) -> ConfigResult<String> {
    let mut output = String::new();
    let mut escaped = false;
...
fn parse_error(line_number: usize, detail: &str) -> ConfigError {
...
fn with_path(error: ConfigError, path: &str) -> ConfigError {
    match error {
        ConfigError::ParseError { format, detail } => ConfigError::ParseError {
            format,
